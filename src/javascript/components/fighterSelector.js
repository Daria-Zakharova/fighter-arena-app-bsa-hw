...
export async function getFighterInfo(fighterId) {
    ...
    const preloadedDetailes = fighterDetailsMap.get(fighterId);
    if (!preloadedDetailes) {
        const detailes = await fighterService.getFighterDetails(fighterId);
        fighterDetailsMap.set(fighterId, detailes);
        return detailes;
    }
    return preloadedDetailes;
}
